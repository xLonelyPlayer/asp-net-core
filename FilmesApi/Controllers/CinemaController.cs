...
public class CinemaController : ControllerBase
{
    ...
    public IEnumerable<ReadCinemaDto> RecuperaCinemas([FromQuery] int? enderecoId = null)
    {
        ...
        return _mapper.Map<List<ReadCinemaDto>>(_context.Cinemas.FromSqlRaw($"Select Id, Nome, EnderecoId FROM filme.cinemas AS fc WHERE fc.EnderecoId = {enderecoId}").ToList());
    }
